import { update, SignalImplementation } from '../index'
import { test } from './mutt'

export const testImplementation = (implementation: string, { signal, computed, effect }: SignalImplementation) => {
  test(`(sz) ${implementation} signal implementation`, (t) => {
